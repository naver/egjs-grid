...
<head>
    <meta charset="utf-8">
    <title>Source: node_modules/@egjs/component/src/ActualComponentEvent.ts | egjs::Grid - API</title>
...
<li class="item" data-name="Grid.PackingGrid">
    ...
    <span class="subtitle">Members</span>
        ...
        <li data-name="Grid.PackingGrid#align"><a href="Grid.PackingGrid.html#align">align</a></li>
    
        <li data-name="Grid.PackingGrid#column"><a href="Grid.PackingGrid.html#column">column</a></li>
    
        <li data-name="Grid.PackingGrid#columnSize"><a href="Grid.PackingGrid.html#columnSize">columnSize</a></li>
    
        <li data-name="Grid.PackingGrid#columnSizeRatio"><a href="Grid.PackingGrid.html#columnSizeRatio">columnSizeRatio</a></li>
...
export default ComponentEvent;
        ...
        <footer>
            Documentation generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc 0.3.10</a> on Tue Mar 23 2021 17:42:22 GMT+0900 (대한민국 표준시)
        </footer>
    </div>
</div>
