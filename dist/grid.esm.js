...
function (_super) {
  ...
  function Grid(containerElement, options) {
    ...
    var _a = _this.options,
        ...
        externalItemRenderer = _a.externalItemRenderer; // TODO: 테스트용 설정
...
function getExpectedColumnSize(item, rowSize) {
  ...
  var inlineOffset = parseFloat(item.attributes.inlineOffset) || 0;
  var contentOffset = parseFloat(item.attributes.contentOffset) || 0;
...
export default Grid;
export { ContainerManager, DEFAULT_GRID_OPTIONS, FrameGrid, GRID_EVENTS, GRID_METHODS, GRID_PROPERTY_TYPES, GetterSetter, GridItem, JustifiedGrid, MOUNT_STATE, MasonryGrid, PROPERTY_TYPE, PackingGrid, RECT_NAMES, UPDATE_STATE, withGridMethods, withMethods };
